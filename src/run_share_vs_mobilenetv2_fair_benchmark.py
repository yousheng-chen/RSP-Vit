...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run shared-weight ViT vs official MobileNetV2 across all noisy datasets and generate summary charts."
    )
...
def main() -> None:
    ...
    benchmark_name = args.benchmark_name or f"share_vs_mobilenetv2_fair_benchmark_{time.strftime('%Y%m%d_%H%M%S')}"
